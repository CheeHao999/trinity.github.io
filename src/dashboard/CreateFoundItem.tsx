...
const CreateFoundItem: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await client.post('/found-items', formData);
      navigate('/found-items');
    } catch (err: any) {
      setError(err.message || 'Failed to create found item report');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="max-w-3xl mx-auto animate-fade-in">
      ...
      <div className="border-2 border-white bg-surface p-10 relative">
        ...
        <h1 className="text-4xl md:text-5xl font-black uppercase mb-10 tracking-tighter text-white">Report Found Item</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="group">
              <label htmlFor="foundDate" className="block text-xs font-bold uppercase tracking-widest text-gray-500 mb-2 group-focus-within:text-white transition-colors">
                Date Found
              </label>
              <input
                id="foundDate"
